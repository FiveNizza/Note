...
public class DeleteNoteCommand1 implements ActionCommand {
    private String page = null;
    private static final String query = "DELETE FROM \"user\".\"note\" WHERE id_note = ?;";
